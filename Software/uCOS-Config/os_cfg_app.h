...
* LICENSING TERMS:
* ---------------
*       uC/OS-II  is provided in source form to registered licensees.  It is illegal to distribute this source
...
*/
                                                            ...
                                                            /* --------------------- MISCELLANEOUS ------------------ */
#define  OS_CFG_MSG_POOL_SIZE            450u               /* Maximum number of messages                             */
